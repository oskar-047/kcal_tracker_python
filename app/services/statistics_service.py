...
def get_graph(user_repo: UserRepo, meal_repo: MealRepo, food_repo: FoodRepo, name: str, params: list):
    ...
    return dispatch[name](user_repo, meal_repo, food_repo, ctx, params)
